...
// Import local images
const userImage = require("../assets/profileimg.jpg");
const profileImage = require("../assets/profileimg.jpg");
...
const storyImage1 = require("../assets/profileimg.jpg");
const storyImage2 = require("../assets/image2.jpeg");
const storyImage3 = require("../assets/image3.webp");
const storyImage4 = require("../assets/image2.jpeg");
        ...
        renderItem={({ item }) => (
          <View style={styles.post}>
            <View style={styles.postHeader}>
              <Image source={item.image} style={styles.postUserImage} />
              <View>
